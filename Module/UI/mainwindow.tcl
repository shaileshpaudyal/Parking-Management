...
#  Feb 13, 2019 11:28:33 AM +0545  platform: Windows NT
set vTcl(timestamp) ""
...
vTcl:font:add_font \
    "-family Arial -size 20 -weight bold -slant roman -underline 0 -overstrike 0" \
    user \
    vTcl:font10
#################################
#LIBRARY PROCEDURES
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 1366x715+-199+62
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    frame $top.fra43 \
        ...
        -width 665 
    vTcl:DefineAlias "$top.fra43" "Frame_SysInfo" vTcl:WidgetProc "Window_Parking_Management" 1
    set site_3_0 $top.fra43
    label $site_3_0.lab44 \
        -background {#d9d9d9} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} -text Time 
    vTcl:DefineAlias "$site_3_0.lab44" "Label_SysTime" vTcl:WidgetProc "Window_Parking_Management" 1
    label $site_3_0.lab45 \
        -background {#d9d9d9} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} -text Date 
    vTcl:DefineAlias "$site_3_0.lab45" "Label_SysDate" vTcl:WidgetProc "Window_Parking_Management" 1
    label $site_3_0.lab46 \
        -background {#d9d9d9} -disabledforeground {#a3a3a3} \
        -font TkDefaultFont -foreground {#000000} -text {User Detail} 
    vTcl:DefineAlias "$site_3_0.lab46" "Label_SysUser" vTcl:WidgetProc "Window_Parking_Management" 1
    place $site_3_0.lab44 \
        -in $site_3_0 -x 10 -y 20 -anchor nw -bordermode ignore 
    place $site_3_0.lab45 \
        -in $site_3_0 -x 180 -y 20 -anchor nw -bordermode ignore 
    place $site_3_0.lab46 \
        -in $site_3_0 -x 400 -y 20 -width 74 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab43 \
        -in $top -x 60 -y 20 -width 543 -relwidth 0 -height 40 -relheight 0 \
    ...
    place $top.fra45 \
        ...
        -anchor nw -bordermode ignore 
    place $top.fra43 \
        -in $top -x 690 -y 10 -width 665 -relwidth 0 -height 55 -relheight 0 \
        -anchor nw -bordermode ignore 
